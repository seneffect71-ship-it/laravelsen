...
<html lang="en">
  ...
  <body>
    <div class="container mt-3 d-flex justify-content-between align-items-center">
        <h2 class="h4 mb-0">Tambah Dosen</h2>
        <div class="d-flex gap-2">
            <a href="{{ route('dashboard') }}" class="btn btn-outline-secondary">Dashboard</a>
            <a href="{{ url('/dosen') }}" class="btn btn-outline-primary">Data Dosen</a>
        </div>
    </div>
    <form action="{{route('dosen.save')}}"  method="post" class="container mt-3">
        @csrf
        <table class="table table-dark table-striped-columns">
            ...
            <tr>
                ...
                <td>:</td>
                <td><input type="text" name="Pendidikan_Terakhir" class="form-control"></td>
            </tr>
            <tr>
                <td>Jurusan Utama</td>
                <td>:</td>
