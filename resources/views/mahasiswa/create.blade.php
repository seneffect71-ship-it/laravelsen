...
<html lang="en">
  <head>
    ...
    <title>Tambah Mahasiswa - ITBSS</title>
  ...
  <body>
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between gap-3 mb-3">
        <div>
            ...
            <h2 class="h3 mb-1">Tambah Mahasiswa</h2>
            <p class="text-muted mb-0">Lengkapi biodata mahasiswa baru.</p>
        </div>
    ...
    <form action="{{route('mahasiswa.save')}}" method="post" class="row g-3">
        @csrf
